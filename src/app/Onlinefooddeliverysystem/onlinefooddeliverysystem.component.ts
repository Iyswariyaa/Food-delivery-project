...
@Component({
  selector: 'app-onlinefooddeliverysystemcomponent',
  templateUrl: './onlinefooddeliverysystem.component.html',
  styleUrls: ['./onlinefooddeliverysystem.component.css'],
})
export class onlinefooddeliverysystemComponent implements OnInit {
  orderFinished = false;
  name: any;
  showSearch = false;
  products: Product[];
